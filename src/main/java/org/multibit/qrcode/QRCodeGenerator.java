...
public class QRCodeGenerator {
    ...
    public ByteMatrix encode(String contents) throws WriterException {
        ...
        // removed 'code' argument as per new com.google.zxing.qrcode.encoder 
		// as per new encode() API specs https://zxing.github.io/zxing/apidocs/com/google/zxing/qrcode/encoder/Encoder.html
        // assigning 'code' to QRCode returned by encode()
        // changed by (Victor Skovorodnikov August 10, 2020)
        code = Encoder.encode(contents, ErrorCorrectionLevel.L, null); 
